...
UPDATE students
SET email = 'john.jj@example.com'
WHERE student_id = 1;

-- 3) Update
-- Update the email for a specific student
UPDATE students
SET last_name = 'Max', email = 'jane.max@example.com'
...
-- 6) Insert data into 'archived_students' by selecting from 'students'
...
FROM students
WHERE enrollment_date = '2026-05-04';
